...
namespace NetCore.Fundamentals.OIC.Conference.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //        options.Audience = "netcore_fundamentals_conference_api";
            //    });
            ...
            services.AddAuthentication(
                ...
                {
                    options.Authority = "https://localhost:44393";
                    options.ApiName = "netcore_fundamentals_conference_api";
